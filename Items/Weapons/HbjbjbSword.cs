...
namespace CalsuStuff.Items.Weapons
{
	public class HbjbjbSword : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("The sword of kings, filled with power absorbed by the spirits of holy wards. You've come far, and can go farther!");  //The (English) text shown below your weapon's name
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<Placeable.HbjbjbBar>(), 10);
